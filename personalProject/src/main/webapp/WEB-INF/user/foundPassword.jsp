		...
		<div
			...
			<div class="modal-dialog" role="document">
				<div class="modal-content rounded-4 shadow">
					<div class="modal-header p-5 pb-4 border-bottom-0 loginBoxColor alienCenter">
					...
					<div class="modal-body form-signin w-100 m-auto p-5 pt-0 ">
						<form class="">
							<div class="form-floating loginform mt-5 mb-5 foundBasicFont">
								<span>000</span>의 등록된
								<h2 class="foundH2Font">qwer123@naver.com</h2>
								메일로 임시비밀번호가
								<p>전송되었습니다.</p>
							</div>
							...
							<div class="mb-3 ">
								<button
									class=" w-100 mb-2 btn btn-lg rounded-3 btn-outline-dark  "

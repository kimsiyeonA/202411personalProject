...
<div class="container-fluid p-0">
  <footer class="d-flex flex-wrap justify-content-between align-items-center py-3 footercss">
    ...
    <div class="col-md-4 d-flex align-items-center justify-content-center text-center">
      <a href="/" class="mb-3 me-2 mb-md-0 text-body-secondary text-decoration-none lh-1">
        <img src="../resources/img/titlelogo.png" width="48" height="24" class="bi me-2" />
      </a>
      <span class="mb-3 mb-md-0 text-body-secondary">&copy; 2024 Company, ksy</span>
    </div>

    <ul class="nav col-md-4 justify-content-center list-unstyled d-flex">
      <li class="ms-3"><a class="text-body-secondary" href="https://x.com/">
      ...
      <li class="ms-3"><a class="text-body-secondary" href="https://www.facebook.com/">
